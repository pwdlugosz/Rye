...
namespace Rye.Aggregates
{
    ...
    public sealed class AggregateIntercept : AggregateStatCo
    {
        ...
        public AggregateIntercept(Expression X, Expression Y, Expression W, Filter F)
            : base(X, Y, W, F)
        {
        }

        public AggregateIntercept(Expression X, Expression Y, Filter F)
            : base(X, Y, F)
        {
        }

        public AggregateIntercept(Expression X, Expression Y, Expression W)
            : base(X, Y, W)
        {
        }

        public AggregateIntercept(Expression X, Expression Y)
            : base(X, Y)
        {
        }
