...
namespace Rye.MatrixExpressions
{
    ...
    public sealed class MatrixExpressionAdd : MatrixExpression
    {

        public MatrixExpressionAdd(MatrixExpression Parent)
            : base(Parent)
        {
        }
        ...
        {
            MatrixExpression node = new MatrixExpressionAdd(this.ParentNode);
